...
t2infile = Dataset("/home/users/kieran/incompass/users/kieran/era5/single-level-monthly-means/total_cloud_cover.nc")
t2 = t2infile.variables['tcc'][:]*100
...
cb.set_label(u"Mean total cloud cover (%)")
